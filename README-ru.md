<div align="center">
  ...
  [Загрузить](https://github.com/jacksnotes/JackNotes/releases) | [Официальная страница](https://jacknotes.dev/)

  <a href="https://github.com/jacksnotes/JackNotes/releases/latest">
    <img src="https://img.shields.io/github/release/jacksnotes/JackNotes.svg?style=flat-square" alt="">
  </a>

  <a href="https://github.com/jacksnotes/JackNotes/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/jacksnotes/JackNotes.svg?style=flat-square" alt="">
  </a>

  <a href="https://github.com/jacksnotes/JackNotes/releases/latest">
    <img alt="GitHub All Releases" src="https://img.shields.io/github/downloads/jacksnotes/JackNotes/total.svg?color=%2312b886&style=flat-square">
  </a>

</div>

<div align="center">
  <img src="./jacknotes-app.png">

</div>

[English](https://github.com/jacksnotes/JackNotes/blob/main/README.md) | Русский | [简体中文](https://github.com/jacksnotes/JackNotes/blob/main/README-zh_CN.md)  | [繁體中文](https://github.com/jacksnotes/JackNotes/blob/main/README-zh_TW.md)

**[CHANGELOG](https://github.com/jacksnotes/JackNotes/blob/main/CHANGELOG.md)**

👏  Спасибо, что используете **JackNotes**！

✍️  **JackNotes** это статичный клиент для ведения блога. Вы можете использовать его для записи событий своей жизни, заметок о настроении, полученых знаний, эссе и идей...
...
🌱  Конечно, **JackNotes** ещё очень молода и имеет немного недостатков, но, поверьте, она продолжает двигаться вперед и развиваться 🏃
...
## Разработка
Если вы хотите внести свой вклад в код, пожалуйста, проверьте [Contribution Guide (он правда на китайском)](https://github.com/jacksnotes/JackNotes/wiki/%E8%B4%A1%E7%8C%AE%E6%8C%87%E5%8D%97) на всякий случай.
...
Мы приветствуем все идеи и улучшения. Вы можете отправлять любые идеи в виде [pull requests](https://github.com/jacksnotes/JackNotes/pulls) или как GitHub [issues](https://github.com/jacksnotes/JackNotes/issues).   
