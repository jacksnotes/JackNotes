...
import VercelDeploy from '../plugins/deploys/vercel'
import WordPressDeploy from '../plugins/deploys/wordpress'
...
export default class DeployEvents {
  constructor(appInstance: any) {
    ...
    const vercel = new VercelDeploy(appInstance)
    const wordpress = new WordPressDeploy(appInstance)
