const message = {
  zhHans: {
    ...
    connectFailed: '远程连接失败，请检查网络、仓库、用户名和令牌设置，或选择API',
  ...
  zh_TW: {
    ...
    connectFailed: '遠程連接失敗，請檢查網路、倉庫、用戶名和令牌設置，或選擇API',
    sourceFolder: '站点源文件路径',
    language: '語 言',
    inConfig: '配置中',
    searchArticle: '搜索文章',
  ...
  en: {
    ...
    connectFailed: 'Remote connection failed, please check network, repository, username and token settings, or choose API',
